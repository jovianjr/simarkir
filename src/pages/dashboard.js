    ...
    return (
        <SideMenu>
            ...
            <section class="h-screen bg-white overflow-auto">
                ...
                <div class="backdrop-blur-lg shadow-lg rounded-lg mt-6 mb-6
                md:flex min-w-full md:items-baseline md:justify-between inline-flex overflow-hidden">
                    <div class="min-w-full p-5 md:flex md:items-baseline">
                        <div class="w-1/2 rounded-lg bg-black border border-gray/50 mr-1">
                            <h3 class="font-black text-white text-sm m-2 p-2">Jumlah Motor Masuk</h3>
                            <p class="font-black text-white text-xl mr-4 ml-4 mb-4"> 00 </p>
                        </div>

                        <div class="w-1/2 rounded-lg bg-white border border-gray/50 ml-1">
                            <h3 class="font-black text-black text-sm m-2 p-2">Jumlah Mobil Masuk</h3>
                            <p class="font-black text-black text-xl mr-4 ml-4 mb-4"> 00 </p>
                        </div>
                    </div>
                </div>

                <div class="flex flex-col mt-8">
                    <h2 class="mt-4 mb-4"> Kendaraan Masuk Hari Ini</h2>
