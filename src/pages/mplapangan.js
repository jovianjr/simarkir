			...
			<section class="h-screen overflow-auto bg-white">
				...
				<div class="md:flex md:items-center md:justify-between">
					<div class="md:flex md:items-center">
						<div class="mr-3 divide-x divide-white/5 rounded-lg bg-red text-white md:flex md:items-center md:justify-between">
						...
						<div class="divide-x divide-white/5 rounded-lg bg-gray-800 text-white md:flex md:items-center md:justify-between">
