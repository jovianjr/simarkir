            ...
            <div class="border border-gray-200 drop-shadow-lg max-w-2xl mx-auto bg-white rounded-lg p-16">
                <form>
                    ...
                    <div class="mb-5">
                        ...
                        <p class="subt">
                            Menambahkan daftar kendaraan milik civitas DTETI.
                        </p>
                    </div>
                    ...
                    <div class="min-w-full md:flex md:items-baseline md:justify-end inline-flex overflow-hidden">
                        <button type="submit"
                            class="w-min px-5 py-2 mt-5 text-sm font-bold text-gray-800
                        ...
                        <button type="cancel" class="min-w-0 px-5 py-2 mt-5 ml-2 text-sm font-bold text-gray-800">   
                            Batal
                        </button>
                    </div>
